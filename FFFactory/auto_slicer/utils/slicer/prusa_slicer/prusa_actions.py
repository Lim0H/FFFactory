import os
from .prusa_cmd_tools import DctExportGcode, PrusaExportGcodeCmdRunner
from ..slicer_types import FlagOptionType
from FFFactory.utils.systems_util import ExistsDirNameType, ExistsDirType
...
class PrusaActionsRunner(SlicerActionsRunnerBase):
    ...
    def get_info(self, input_file: str) -> str:
        pass

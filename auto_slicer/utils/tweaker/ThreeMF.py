    ...
    try:
        ...
        for c, obj in enumerate(objects):
            ...
            for triangle in triangles:
                ...
                obj_meshs[c]["mesh"].append(
                    [float(vertex_list[v1][0]), float(vertex_list[v1][1]), float(vertex_list[v1][2])]
                )
                obj_meshs[c]["mesh"].append(
                    [float(vertex_list[v2][0]), float(vertex_list[v2][1]), float(vertex_list[v2][2])]
                )
                obj_meshs[c]["mesh"].append(
                    [float(vertex_list[v3][0]), float(vertex_list[v3][1]), float(vertex_list[v3][2])]
                )
